 ...
 * generated by Xtext
 */
package org.eclipse.xtext.botlib.dsl.ui.contentassist.antlr;
...
public class BotDuinoParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.eclipse.xtext.botlib.dsl.ui.contentassist.antlr.internal.InternalBotDuinoParser createParser() {
		org.eclipse.xtext.botlib.dsl.ui.contentassist.antlr.internal.InternalBotDuinoParser result = new org.eclipse.xtext.botlib.dsl.ui.contentassist.antlr.internal.InternalBotDuinoParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRulesAccess().getAlternatives(), "rule__Rules__Alternatives");
					put(grammarAccess.getMethodsAccess().getAlternatives(), "rule__Methods__Alternatives");
					put(grammarAccess.getBTRuleAccess().getAlternatives_2(), "rule__BTRule__Alternatives_2");
					put(grammarAccess.getSensorIRRuleAccess().getAlternatives_2(), "rule__SensorIRRule__Alternatives_2");
					put(grammarAccess.getSensorIRRuleAccess().getAlternatives_3(), "rule__SensorIRRule__Alternatives_3");
					put(grammarAccess.getSensorSR04RuleAccess().getAlternatives_2(), "rule__SensorSR04Rule__Alternatives_2");
					put(grammarAccess.getCTRLRuleAccess().getAlternatives_2(), "rule__CTRLRule__Alternatives_2");
					put(grammarAccess.getCTRLRuleAccess().getAlternatives_3(), "rule__CTRLRule__Alternatives_3");
					put(grammarAccess.getButtonRuleAccess().getAlternatives_2(), "rule__ButtonRule__Alternatives_2");
					put(grammarAccess.getButtonRuleAccess().getAlternatives_3(), "rule__ButtonRule__Alternatives_3");
					put(grammarAccess.getVarRuleAccess().getAlternatives_2(), "rule__VarRule__Alternatives_2");
					put(grammarAccess.getLEDMethodsAccess().getAlternatives_2(), "rule__LEDMethods__Alternatives_2");
					put(grammarAccess.getMotorMethodsAccess().getAlternatives(), "rule__MotorMethods__Alternatives");
					put(grammarAccess.getMotorMethodsAccess().getAlternatives_1_2(), "rule__MotorMethods__Alternatives_1_2");
					...
					put(grammarAccess.getMotorAccess().getGroup(), "rule__Motor__Group__0");
					put(grammarAccess.getMotorAccess().getGroup_2(), "rule__Motor__Group_2__0");
					put(grammarAccess.getSensorIRAccess().getGroup(), "rule__SensorIR__Group__0");
					put(grammarAccess.getSensorIRAccess().getGroup_2(), "rule__SensorIR__Group_2__0");
					put(grammarAccess.getSensorSR04Access().getGroup(), "rule__SensorSR04__Group__0");
					put(grammarAccess.getSensorSR04Access().getGroup_2(), "rule__SensorSR04__Group_2__0");
					put(grammarAccess.getBlueToothAccess().getGroup(), "rule__BlueTooth__Group__0");
					put(grammarAccess.getBlueToothAccess().getGroup_2(), "rule__BlueTooth__Group_2__0");
					put(grammarAccess.getCTRLAccess().getGroup(), "rule__CTRL__Group__0");
					put(grammarAccess.getCTRLAccess().getGroup_2(), "rule__CTRL__Group_2__0");
					put(grammarAccess.getServoAccess().getGroup(), "rule__Servo__Group__0");
					put(grammarAccess.getServoAccess().getGroup_2(), "rule__Servo__Group_2__0");
					put(grammarAccess.getBTRuleAccess().getGroup(), "rule__BTRule__Group__0");
					put(grammarAccess.getSensorIRRuleAccess().getGroup(), "rule__SensorIRRule__Group__0");
					put(grammarAccess.getSensorSR04RuleAccess().getGroup(), "rule__SensorSR04Rule__Group__0");
					put(grammarAccess.getSensorSR04RuleAccess().getGroup_3(), "rule__SensorSR04Rule__Group_3__0");
					...
					put(grammarAccess.getVarRuleAccess().getGroup(), "rule__VarRule__Group__0");
					put(grammarAccess.getAttrVarAccess().getGroup(), "rule__AttrVar__Group__0");
					put(grammarAccess.getProcAccess().getGroup(), "rule__Proc__Group__0");
					put(grammarAccess.getProcAccess().getGroup_2(), "rule__Proc__Group_2__0");
					put(grammarAccess.getLoopAccess().getGroup(), "rule__Loop__Group__0");
					put(grammarAccess.getLEDMethodsAccess().getGroup(), "rule__LEDMethods__Group__0");
					put(grammarAccess.getLEDMethodsAccess().getGroup_2_2(), "rule__LEDMethods__Group_2_2__0");
					put(grammarAccess.getMotorMethodsAccess().getGroup_1(), "rule__MotorMethods__Group_1__0");
					put(grammarAccess.getMotorMethodsAccess().getGroup_1_2_3(), "rule__MotorMethods__Group_1_2_3__0");
					put(grammarAccess.getMotorMethodsAccess().getGroup_1_2_4(), "rule__MotorMethods__Group_1_2_4__0");
					put(grammarAccess.getWaitMethodAccess().getGroup(), "rule__WaitMethod__Group__0");
					put(grammarAccess.getCallProcAccess().getGroup(), "rule__CallProc__Group__0");
					...
					put(grammarAccess.getButtonAccess().getSuperTypeAssignment_2_1(), "rule__Button__SuperTypeAssignment_2_1");
					put(grammarAccess.getButtonAccess().getValuesAssignment_4(), "rule__Button__ValuesAssignment_4");
					put(grammarAccess.getMotorAccess().getNameAssignment_1(), "rule__Motor__NameAssignment_1");
					put(grammarAccess.getMotorAccess().getSuperTypeAssignment_2_1(), "rule__Motor__SuperTypeAssignment_2_1");
					put(grammarAccess.getMotorAccess().getValuesAssignment_4(), "rule__Motor__ValuesAssignment_4");
					put(grammarAccess.getMotorAccess().getValuesAssignment_6(), "rule__Motor__ValuesAssignment_6");
					put(grammarAccess.getMotorAccess().getValuesAssignment_8(), "rule__Motor__ValuesAssignment_8");
					put(grammarAccess.getSensorIRAccess().getNameAssignment_1(), "rule__SensorIR__NameAssignment_1");
					put(grammarAccess.getSensorIRAccess().getSuperTypeAssignment_2_1(), "rule__SensorIR__SuperTypeAssignment_2_1");
					put(grammarAccess.getSensorIRAccess().getValuesAssignment_4(), "rule__SensorIR__ValuesAssignment_4");
					put(grammarAccess.getSensorSR04Access().getNameAssignment_1(), "rule__SensorSR04__NameAssignment_1");
					put(grammarAccess.getSensorSR04Access().getSuperTypeAssignment_2_1(), "rule__SensorSR04__SuperTypeAssignment_2_1");
					put(grammarAccess.getSensorSR04Access().getValuesAssignment_4(), "rule__SensorSR04__ValuesAssignment_4");
					put(grammarAccess.getSensorSR04Access().getValuesAssignment_6(), "rule__SensorSR04__ValuesAssignment_6");
					put(grammarAccess.getBlueToothAccess().getNameAssignment_1(), "rule__BlueTooth__NameAssignment_1");
					put(grammarAccess.getBlueToothAccess().getSuperTypeAssignment_2_1(), "rule__BlueTooth__SuperTypeAssignment_2_1");
					put(grammarAccess.getBlueToothAccess().getValuesAssignment_4(), "rule__BlueTooth__ValuesAssignment_4");
					put(grammarAccess.getBlueToothAccess().getValuesAssignment_6(), "rule__BlueTooth__ValuesAssignment_6");
					put(grammarAccess.getCTRLAccess().getNameAssignment_1(), "rule__CTRL__NameAssignment_1");
					put(grammarAccess.getCTRLAccess().getSuperTypeAssignment_2_1(), "rule__CTRL__SuperTypeAssignment_2_1");
					put(grammarAccess.getCTRLAccess().getValuesAssignment_4(), "rule__CTRL__ValuesAssignment_4");
					put(grammarAccess.getCTRLAccess().getValuesAssignment_6(), "rule__CTRL__ValuesAssignment_6");
					put(grammarAccess.getCTRLAccess().getValuesAssignment_8(), "rule__CTRL__ValuesAssignment_8");
					put(grammarAccess.getCTRLAccess().getValuesAssignment_10(), "rule__CTRL__ValuesAssignment_10");
					put(grammarAccess.getCTRLAccess().getValuesAssignment_12(), "rule__CTRL__ValuesAssignment_12");
					put(grammarAccess.getServoAccess().getNameAssignment_1(), "rule__Servo__NameAssignment_1");
					put(grammarAccess.getServoAccess().getSuperTypeAssignment_2_1(), "rule__Servo__SuperTypeAssignment_2_1");
					put(grammarAccess.getServoAccess().getValuesAssignment_4(), "rule__Servo__ValuesAssignment_4");
					put(grammarAccess.getServoAccess().getValuesAssignment_6(), "rule__Servo__ValuesAssignment_6");
					put(grammarAccess.getServoAccess().getValuesAssignment_8(), "rule__Servo__ValuesAssignment_8");
					put(grammarAccess.getBTRuleAccess().getSuperTypeAssignment_1(), "rule__BTRule__SuperTypeAssignment_1");
					put(grammarAccess.getBTRuleAccess().getOpAssignment_2_0(), "rule__BTRule__OpAssignment_2_0");
					put(grammarAccess.getBTRuleAccess().getOpAssignment_2_1(), "rule__BTRule__OpAssignment_2_1");
					put(grammarAccess.getBTRuleAccess().getNameAssignment_3(), "rule__BTRule__NameAssignment_3");
					put(grammarAccess.getBTRuleAccess().getThenPartAssignment_5(), "rule__BTRule__ThenPartAssignment_5");
					put(grammarAccess.getSensorIRRuleAccess().getSuperTypeAssignment_1(), "rule__SensorIRRule__SuperTypeAssignment_1");
					put(grammarAccess.getSensorIRRuleAccess().getOpAssignment_2_0(), "rule__SensorIRRule__OpAssignment_2_0");
					put(grammarAccess.getSensorIRRuleAccess().getOpAssignment_2_1(), "rule__SensorIRRule__OpAssignment_2_1");
					put(grammarAccess.getSensorIRRuleAccess().getActionsAssignment_3_0(), "rule__SensorIRRule__ActionsAssignment_3_0");
					put(grammarAccess.getSensorIRRuleAccess().getActionsAssignment_3_1(), "rule__SensorIRRule__ActionsAssignment_3_1");
					put(grammarAccess.getSensorIRRuleAccess().getThenPartAssignment_5(), "rule__SensorIRRule__ThenPartAssignment_5");
					put(grammarAccess.getSensorSR04RuleAccess().getSuperTypeAssignment_1(), "rule__SensorSR04Rule__SuperTypeAssignment_1");
					put(grammarAccess.getSensorSR04RuleAccess().getOpAssignment_2_0(), "rule__SensorSR04Rule__OpAssignment_2_0");
					put(grammarAccess.getSensorSR04RuleAccess().getOpAssignment_2_1(), "rule__SensorSR04Rule__OpAssignment_2_1");
					put(grammarAccess.getSensorSR04RuleAccess().getOpAssignment_2_2(), "rule__SensorSR04Rule__OpAssignment_2_2");
					put(grammarAccess.getSensorSR04RuleAccess().getOpAssignment_2_3(), "rule__SensorSR04Rule__OpAssignment_2_3");
					put(grammarAccess.getSensorSR04RuleAccess().getValueAssignment_3_0(), "rule__SensorSR04Rule__ValueAssignment_3_0");
					put(grammarAccess.getSensorSR04RuleAccess().getThenPartAssignment_5(), "rule__SensorSR04Rule__ThenPartAssignment_5");
					put(grammarAccess.getCTRLRuleAccess().getSuperTypeAssignment_1(), "rule__CTRLRule__SuperTypeAssignment_1");
					put(grammarAccess.getCTRLRuleAccess().getOpAssignment_2_0(), "rule__CTRLRule__OpAssignment_2_0");
					put(grammarAccess.getCTRLRuleAccess().getOpAssignment_2_1(), "rule__CTRLRule__OpAssignment_2_1");
					put(grammarAccess.getCTRLRuleAccess().getActionsAssignment_3_0(), "rule__CTRLRule__ActionsAssignment_3_0");
					put(grammarAccess.getCTRLRuleAccess().getActionsAssignment_3_1(), "rule__CTRLRule__ActionsAssignment_3_1");
					put(grammarAccess.getCTRLRuleAccess().getActionsAssignment_3_2(), "rule__CTRLRule__ActionsAssignment_3_2");
					put(grammarAccess.getCTRLRuleAccess().getActionsAssignment_3_3(), "rule__CTRLRule__ActionsAssignment_3_3");
					put(grammarAccess.getCTRLRuleAccess().getThenPartAssignment_5(), "rule__CTRLRule__ThenPartAssignment_5");
					put(grammarAccess.getButtonRuleAccess().getSuperTypeAssignment_1(), "rule__ButtonRule__SuperTypeAssignment_1");
					put(grammarAccess.getButtonRuleAccess().getOpAssignment_2_0(), "rule__ButtonRule__OpAssignment_2_0");
					put(grammarAccess.getButtonRuleAccess().getOpAssignment_2_1(), "rule__ButtonRule__OpAssignment_2_1");
					put(grammarAccess.getButtonRuleAccess().getActionsAssignment_3_0(), "rule__ButtonRule__ActionsAssignment_3_0");
					put(grammarAccess.getButtonRuleAccess().getActionsAssignment_3_1(), "rule__ButtonRule__ActionsAssignment_3_1");
					put(grammarAccess.getButtonRuleAccess().getThenPartAssignment_5(), "rule__ButtonRule__ThenPartAssignment_5");
					put(grammarAccess.getVarRuleAccess().getSuperTypeAssignment_1(), "rule__VarRule__SuperTypeAssignment_1");
					put(grammarAccess.getVarRuleAccess().getOpAssignment_2_0(), "rule__VarRule__OpAssignment_2_0");
					put(grammarAccess.getVarRuleAccess().getOpAssignment_2_1(), "rule__VarRule__OpAssignment_2_1");
					put(grammarAccess.getVarRuleAccess().getValuesAssignment_3(), "rule__VarRule__ValuesAssignment_3");
					put(grammarAccess.getVarRuleAccess().getThenPartAssignment_5(), "rule__VarRule__ThenPartAssignment_5");
					put(grammarAccess.getAttrVarAccess().getSuperTypeAssignment_0(), "rule__AttrVar__SuperTypeAssignment_0");
					put(grammarAccess.getAttrVarAccess().getValuesAssignment_2(), "rule__AttrVar__ValuesAssignment_2");
					put(grammarAccess.getProcAccess().getNameAssignment_1(), "rule__Proc__NameAssignment_1");
					put(grammarAccess.getProcAccess().getSuperTypeAssignment_2_1(), "rule__Proc__SuperTypeAssignment_2_1");
					put(grammarAccess.getProcAccess().getThenPartAssignment_3(), "rule__Proc__ThenPartAssignment_3");
					put(grammarAccess.getLoopAccess().getThenPartAssignment_1(), "rule__Loop__ThenPartAssignment_1");
					put(grammarAccess.getLEDMethodsAccess().getSuperTypeAssignment_0(), "rule__LEDMethods__SuperTypeAssignment_0");
					put(grammarAccess.getLEDMethodsAccess().getLedFunctionsAssignment_2_0(), "rule__LEDMethods__LedFunctionsAssignment_2_0");
					put(grammarAccess.getLEDMethodsAccess().getLedFunctionsAssignment_2_1(), "rule__LEDMethods__LedFunctionsAssignment_2_1");
					put(grammarAccess.getLEDMethodsAccess().getLedFunctionsAssignment_2_2_0(), "rule__LEDMethods__LedFunctionsAssignment_2_2_0");
					put(grammarAccess.getLEDMethodsAccess().getValueAssignment_2_2_1(), "rule__LEDMethods__ValueAssignment_2_2_1");
					put(grammarAccess.getMotorMethodsAccess().getSuperTypeAssignment_0(), "rule__MotorMethods__SuperTypeAssignment_0");
					put(grammarAccess.getMotorMethodsAccess().getSuperTypeAssignment_1_0(), "rule__MotorMethods__SuperTypeAssignment_1_0");
					put(grammarAccess.getMotorMethodsAccess().getMotorFunctionsAssignment_1_2_0(), "rule__MotorMethods__MotorFunctionsAssignment_1_2_0");
					put(grammarAccess.getMotorMethodsAccess().getMotorFunctionsAssignment_1_2_1(), "rule__MotorMethods__MotorFunctionsAssignment_1_2_1");
					put(grammarAccess.getMotorMethodsAccess().getMotorFunctionsAssignment_1_2_2(), "rule__MotorMethods__MotorFunctionsAssignment_1_2_2");
					put(grammarAccess.getMotorMethodsAccess().getMotorFunctionsAssignment_1_2_3_0(), "rule__MotorMethods__MotorFunctionsAssignment_1_2_3_0");
					put(grammarAccess.getMotorMethodsAccess().getValueAssignment_1_2_3_1(), "rule__MotorMethods__ValueAssignment_1_2_3_1");
					put(grammarAccess.getMotorMethodsAccess().getMotorFunctionsAssignment_1_2_4_0(), "rule__MotorMethods__MotorFunctionsAssignment_1_2_4_0");
					put(grammarAccess.getMotorMethodsAccess().getValueAssignment_1_2_4_1(), "rule__MotorMethods__ValueAssignment_1_2_4_1");
					put(grammarAccess.getWaitMethodAccess().getValueAssignment_1(), "rule__WaitMethod__ValueAssignment_1");
					put(grammarAccess.getCallProcAccess().getSuperTypeAssignment_1(), "rule__CallProc__SuperTypeAssignment_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.eclipse.xtext.botlib.dsl.ui.contentassist.antlr.internal.InternalBotDuinoParser typedParser = (org.eclipse.xtext.botlib.dsl.ui.contentassist.antlr.internal.InternalBotDuinoParser) parser;
