		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMethodsAccess().getSuperTypeAssignment_0(), "rule__Methods__SuperTypeAssignment_0");
					put(grammarAccess.getMethodsAccess().getNameAssignment_2(), "rule__Methods__NameAssignment_2");
