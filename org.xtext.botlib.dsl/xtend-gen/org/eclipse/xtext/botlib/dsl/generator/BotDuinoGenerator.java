...
public class BotDuinoGenerator implements IGenerator {
  ...
  public String compile(final Rules e) {
    String _xblockexpression = null;
    {
      ...
      String _simpleName_2 = SensorRule.class.getSimpleName();
      boolean _equals_3 = Objects.equal(_name_11, _simpleName_2);
      if (_equals_3) {
        SensorRuleImpl ruleClass_1 = ((SensorRuleImpl) e);
        String _c_loop_3 = this.c_loop;
        Sensor _superType_9 = ruleClass_1.getSuperType();
        String _name_12 = _superType_9.getName();
        String _plus_17 = ((this.ind1 + "if(") + _name_12);
        String _plus_18 = (_plus_17 + ".getState() == ");
        EList<String> _sensorActions = ruleClass_1.getSensorActions();
        String _get_1 = _sensorActions.get(0);
        String _plus_19 = (_plus_18 + _get_1);
        String _plus_20 = (_plus_19 + "){ ");
        String _plus_21 = (_plus_20 + this.ql);
        this.c_loop = (_c_loop_3 + _plus_21);
        String _c_loop_4 = this.c_loop;
        XExpression _thenPart_2 = e.getThenPart();
        String _splitExp_2 = this.splitExp(((ObjectLiteralImpl) _thenPart_2));
        String _plus_22 = (_splitExp_2 + this.ql);
        this.c_loop = (_c_loop_4 + _plus_22);
        String _c_loop_5 = this.c_loop;
        this.c_loop = (_c_loop_5 + ((this.ind1 + "}") + this.ql));
      }
      String _xifexpression = null;
      EClass _eClass_3 = e.eClass();
      String _name_13 = _eClass_3.getName();
      String _simpleName_3 = Proc.class.getSimpleName();
      boolean _equals_4 = Objects.equal(_name_13, _simpleName_3);
      if (_equals_4) {
        String _xblockexpression_1 = null;
        {
          ...
          String _name_14 = proc.getName();
          _builder_5.append(_name_14, "");
          _builder_5.append("(){ ");
          String _plus_23 = (_builder_5.toString() + this.ql);
          this.proc_block = (_proc_block + _plus_23);
          String _proc_block_1 = this.proc_block;
          XExpression _thenPart_3 = e.getThenPart();
          String _splitExp_3 = this.splitExp(((ObjectLiteralImpl) _thenPart_3));
          String _plus_24 = (_splitExp_3 + this.ql);
          this.proc_block = (_proc_block_1 + _plus_24);
