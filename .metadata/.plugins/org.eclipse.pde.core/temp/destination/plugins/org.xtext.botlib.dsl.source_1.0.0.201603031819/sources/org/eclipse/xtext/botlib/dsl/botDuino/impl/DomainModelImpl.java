 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xtext.botlib.dsl.botDuino.impl.DomainModelImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DomainModelImpl extends MinimalEObjectImpl.Container implements DomainModel
{
  ...
  {
    return BotDuinoPackage.Literals.DOMAIN_MODEL;
  }
  ...
  public EList<Entity> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<Entity>(Entity.class, this, BotDuinoPackage.DOMAIN_MODEL__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case BotDuinoPackage.DOMAIN_MODEL__ELEMENTS:
